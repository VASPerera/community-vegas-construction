  ...
  const fetchBudgetDetails = async () => {
    try {
      ...
      if (budgetData && Array.isArray(budgetData) && budgetData.length > 0) {
        const totalBudget = budgetData.reduce((sum: number, budget: any) => 
          sum + (budget.allocatedAmount || 0), 0
        );
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-bold">{projectStatistics.projectProgress}%</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium text-gray-500">Budget Usage</span>
                        <span className="text-sm font-bold">{projectStatistics.budgetUsed}%</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium text-gray-500">Active Tasks</span>
                        <span className="text-sm font-bold">{projectStatistics.activeTasks}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium text-gray-500">Equipment Items</span>
                        <span className="text-sm font-bold">{projectStatistics.equipmentCount}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
